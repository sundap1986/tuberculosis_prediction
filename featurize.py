...
def featurize_data(config_path):
    """Preprocesses the tuberculosis dataset by encoding categorical variables and scaling numerical features."""
    ...
    numerical_features = config['featurize']['numerical_features']
    ...
    with mlflow.start_run():
        ...
        X = df.drop(columns=["Patient_ID", target_column])  # Drop unique ID
        y = df[target_column]
