...
def load_data(config_path):
    ...
    with mlflow.start_run():
        ...
        mlflow.log_param("dataset_url", "https://raw.githubusercontent.com/sundap1986/tuberculosis_prediction/main/tuberculosis_xray_dataset.csv")
        ...
        # Load dataset
        df = pd.read_csv("https://raw.githubusercontent.com/sundap1986/tuberculosis_prediction/main/tuberculosis_xray_dataset.csv")
